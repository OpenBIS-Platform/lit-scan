...
export function initPanel() {
  ...
  renderPanel();
  // Poll to update UI
  updateInterval = setInterval(renderPanel, 1000) as any;
...
function setupDragging() {
  ...
  (window as any).__litScanStartDrag = (e: MouseEvent) => {
    isDragging = true;
    startX = e.clientX;
    startY = e.clientY;
    ...
    <div>
      ...
      <ul style="list-style: none; padding: 0; margin: 5px 0;">
        ${recent.map(r => {
           ...
           if (r.duration > 8) durationColor = '#ffcc00';
           if (r.duration > 16) durationColor = '#ff3b30';
           return `
